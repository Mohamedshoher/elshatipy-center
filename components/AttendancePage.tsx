                            ...
                            <li key={student.id} className="p-4 flex items-center justify-between transition-colors hover:bg-gray-50">
                                ...
                                <div className="flex gap-3">
                                    <button
                                        ...
                                        className={`py-2 px-5 rounded-lg font-semibold text-sm transition-all ${todayAttendance?.status === AttendanceEnum.PRESENT
                                    ...
                                    <button
                                        ...
                                        className={`py-2 px-5 rounded-lg font-semibold text-sm transition-all ${todayAttendance?.status === AttendanceEnum.ABSENT
