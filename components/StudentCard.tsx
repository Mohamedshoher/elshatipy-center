          ...
          <div className="w-full sm:w-auto flex items-center justify-between sm:justify-end gap-3">
              <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div>
                    ...
                    {groupName && <p className="text-xs text-gray-500 mt-0.5">{groupName}</p>}
                  </div>
              </div>
          </div>

          <div className="w-full sm:w-auto flex flex-wrap items-center justify-start gap-x-4 gap-y-2" onClick={(e) => e.stopPropagation()}>
              <div className="flex items-center flex-shrink-0 gap-x-2 order-2 sm:order-1">
