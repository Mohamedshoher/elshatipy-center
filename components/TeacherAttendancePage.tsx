        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden">
            <ul className="divide-y divide-gray-200">
                {activeTeachers.map(teacher => {
                    ...
                    return (
                        <li key={teacher.id} className="p-4 flex items-center justify-between transition-colors hover:bg-gray-50">
                            ...
                            <div className="flex gap-3">
                                <button
                                    ...
                                    className={`py-2 px-5 rounded-lg font-semibold text-sm transition-all ${
                                        !todayAttendance || todayAttendance.status === TeacherAttendanceStatus.PRESENT
                                ...
                                <button
                                    ...
                                    className={`py-2 px-5 rounded-lg font-semibold text-sm transition-all ${
                                        todayAttendance?.status === TeacherAttendanceStatus.ABSENT
