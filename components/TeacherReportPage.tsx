...
import type { Teacher, Group, Student, TeacherAttendanceRecord, TeacherPayrollAdjustment, FinancialSettings, TeacherCollectionRecord } from '../types';
...
const TeacherReportPage: React.FC<TeacherReportPageProps> = ({ teacher, groups, students, teacherAttendance, teacherPayrollAdjustments, financialSettings, onBack, teacherCollections }) => {
